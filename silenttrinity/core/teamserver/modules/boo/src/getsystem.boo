...
public static def Main():
    ...
    securityIdentifier = SecurityIdentifier(WellKnownSidType.LocalSystemSid, null)
    systemAccount as NTAccount
    systemAccount = securityIdentifier.Translate(typeof(NTAccount))
    print "Impersonating " + systemAccount.ToString() + "..."

    ImpersonateUser(systemAccount.ToString())
